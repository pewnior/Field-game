...
$stmt = $polaczenie->prepare("SELECT id, name FROM checkpoints WHERE game_id = ?");
...
<b>Wybierz punkt który chcesz usunąć:</b><br/><br/>
<?php if ($wynik->num_rows === 0): ?>
    <p align="center">Brak punktów</p>
<?php else: ?>
    <form action="old_checkpoint.php" method="get">
